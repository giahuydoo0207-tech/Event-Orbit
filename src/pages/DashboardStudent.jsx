...
export function DashboardStudent() {
  ...
  return (
    <div className="space-y-10 font-sans">
      <div className="student-achievement-hero relative flex flex-col items-start justify-between gap-6 overflow-hidden rounded-xl border border-oc-periwinkle/60 bg-oc-navy p-6 text-white shadow-oc-sm sm:p-8 md:flex-row md:items-center">
