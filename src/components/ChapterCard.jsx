...
export function ChapterCard({ chapter, linkTo }) {
  ...
  return (
    ...
    >
      {/* Outline Icon Box — thin border, text-oc-blue icon */}
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-oc-periwinkle/70 group-hover:border-oc-blue/50 transition-colors">
